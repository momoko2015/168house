...
const i18n = {
    en: {
        ...
        "hero-desc": "Premium properties for rent and sale in Japan's finest locations.",
        "search-placeholder": "Search by city, property type...",
        ...
        "all": "All",
        "services-desc": "Finding your dream home is easier with our streamlined process.",
        "step-1-desc": "Use our advanced search filters to find the perfect property.",
        "step-2-desc": "Book a tour online or request a virtual tour.",
        "step-3-desc": "Complete the paperwork digitally and securely. Move in immediately.",
        "mortgage-desc": "Estimate your monthly payments including principal and interest.",
        ...
        "newsletter-desc": "Get the latest property updates in your inbox.",
        "subscribe": "Subscribe"
    },
    ja: {
        "logo": "エリート・エステート",
        ...
        "prop-pent": "タワーマンション",
        "view-details": "詳細を見る",
        "stats-properties": "物件数",
        "stats-clients": "ハッピーな顧客",
        "stats-awards": "受賞数"
    },
    zh: {
        "logo": "28精選樓盤",
...
let defaultProperties = [
    {
        id: 1,
        title: { en: "Modern Penthouse", ja: "モダン・ペントハウス", zh: "現代頂層特色戶" },
        location: { en: "Tokyo - Shinjuku", ja: "東京 - 新宿", zh: "旺角" },
        price: "¥ 450,000/月",
        type: "rent",
        beds: 3,
        baths: 2,
    ...
    {
        id: 2,
        title: { en: "Luxury Villa", ja: "高級プライベートヴィラ", zh: "淺水灣獨立屋" },
        location: { en: "Kanagawa - Hakone", ja: "神奈川 - 箱根", zh: "淺水灣" },
        price: "¥ 850,000,000",
        type: "sale",
        beds: 5,
        baths: 6,
    ...
    {
        id: 3,
        title: { en: "Skyline Apartment", ja: "スカイライン・アパートメント", zh: "高層海景單位" },
        location: { en: "Tokyo - Shibuya", ja: "東京 - 渋谷", zh: "尖沙咀" },
        price: "¥ 320,000/月",
        type: "rent",
        beds: 2,
        baths: 1,
    ...
    {
        id: 4,
        title: { en: "Oceanfront Estate", ja: "オーシャンフロント・エステート", zh: "西貢海景別墅" },
        location: { en: "Chiba - Kamogawa", ja: "千葉 - 鴨川", zh: "西貢" },
        price: "¥ 1,200,000,000",
        type: "sale",
        beds: 6,
        baths: 7,
    ...
    {
        id: 5,
        title: { en: "Minimalist Loft", ja: "ミニマリスト・ロフト", zh: "工廈靚裝特色戶" },
        location: { en: "Osaka - Namba", ja: "大阪 - 難波", zh: "觀塘" },
        price: "¥ 280,000/月",
        type: "rent",
        beds: 1,
        baths: 1,
    ...
    {
        id: 6,
        title: { en: "Suburban Family Home", ja: "郊外のファミリー向け住宅", zh: "沙田第一城" },
        location: { en: "Saitama - Omiya", ja: "埼玉 - 大宮", zh: "沙田" },
        price: "¥ 65,000,000",
        type: "sale",
        beds: 2,
        baths: 1,
...
function handleSearch() {
    ...
    const filtered = properties.filter(prop => {
        ...
        const titleJa = (prop.title?.ja || '').toLowerCase();
        const titleZh = (prop.title?.zh || '').toLowerCase();
        const locEn = (prop.location?.en || '').toLowerCase();
        const locJa = (prop.location?.ja || '').toLowerCase();
        ...
        const matchesSearch = searchTerm === "" || searchTerms.some(term => {
            ...
            return titleEn.includes(t) || titleJa.includes(t) || titleZh.includes(t) ||
                locEn.includes(t) || locJa.includes(t) || locZh.includes(t) ||
                features.includes(t) ||
                normTitleEn.includes(nt) || normalize(titleJa).includes(nt) || normLocEn.includes(nt);
        });
...
function calculateMortgage() {
    ...
    if (price && rate && term) {
        ...
        if (resultDiv && priceSpan) {
            ...
            priceSpan.innerText = `¥ ${Math.round(monthly).toLocaleString()}`;
        }
    }
}
